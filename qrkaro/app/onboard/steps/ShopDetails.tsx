...
export default function ShopDetails() {
  ...
  const shopTypes = ['Restaurant', 'Cafe', 'Stall', 'Xerox Shop', 'Grocery Store', 'Retail', 'Other'];
  ...
  const handleNext = () => {
  if (validateForm()) {
    console.log('📝 shopType being saved:', formData.shopType);
    setShopDetails(formData);
    setCurrentStep(formData.shopType === 'Xerox Shop' ? 3 : 2);
  }
};
